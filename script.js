...
const characters = letters.getElementsByTagName("p");
// console.log(letters);
// console.log(characters);

for (const currentCharacter of characters) {
  // console.log(currentCharacter);
  currentCharacter.addEventListener("click", function () {
    console.log(currentCharacter.innerText);
    clearMealContainer();

    hitServer("https://www.themealdb.com/api/json/v1/1/search.php?f=" + currentCharacter.innerText)
  })
}
